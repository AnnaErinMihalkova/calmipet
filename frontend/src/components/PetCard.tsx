...
const PetCard: React.FC = () => {
  ...
  const isRaccoon = selected === 'raccoon';
        ...
        {isRaccoon ? (
          <svg width="240" height="240" viewBox="0 0 240 240">
            ...
            <g transform="rotate(6 120 150)">
              <rect x="72" y="74" width="96" height="68" rx="34" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
              <g className="ear">
                <ellipse cx="92" cy="76" rx="16" ry="18" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
                <ellipse cx="148" cy="76" rx="16" ry="18" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
                <ellipse cx="92" cy="78" rx="8" ry="9" fill="#e0d5d5" />
                <ellipse cx="148" cy="78" rx="8" ry="9" fill="#e0d5d5" />
              </g>
              ...
              <path d="M92 100 C 104 90, 136 90, 148 100 L 148 114 C 136 106, 104 106, 92 114 Z" fill="#3a3a3a" />
              <g className="blink">
              ...
              <rect x="94" y="136" width="52" height="38" rx="22" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
              <rect x="90" y="148" width="20" height="12" rx="6" className="arm-left" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
              <rect x="130" y="148" width="20" height="12" rx="6" className="arm-right" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
              <rect x="106" y="180" width="18" height="24" rx="9" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
              <rect x="128" y="180" width="18" height="24" rx="9" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
            </g>
            <g className="tail">
              <ellipse cx="86" cy="182" rx="30" ry="20" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
              <path d="M66 180 C 54 194, 56 210, 80 216 C 104 222, 122 200, 104 188 C 92 179, 76 176, 66 180 Z" fill="url(#fur)" stroke="#2b2b2b" strokeWidth="4" />
              <path d="M74 192 C 70 198, 74 204, 88 208 C 100 211, 114 202, 108 194" stroke="#2b2b2b" strokeWidth="8" fill="none" />
              <path d="M70 202 C 68 206, 74 210, 90 212" stroke="#2b2b2b" strokeWidth="8" fill="none" />
            </g>
            <rect x="72" y="74" width="96" height="68" fill="url(#shadow)" />
          </svg>
        ) : (
          <div style={{ width: 240, height: 240, borderRadius: 24, display: 'grid', placeItems: 'center', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
            <div style={{ fontSize: 120 }}>{emojiMap[selected]}</div>
          </div>
        )}
      </div>
